...
public class Progress : MonoBehaviour
{
    ...
    void Start()
    {
        //Creates a list of the expect order and a queue of the order of pressed items, this will determine whether or not the inputted items are correct
        expectedOrder = new string[] { "Peru", "China", "France", "Egypt" }; // The reference provided was used / modify to help in the creation of the script. This code will be referenced within the report https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/arrays/
        pressedOrder = new Queue<string>(new string[] { "UK", "UK", "UK", "UK" }); // The reference provided was used / modify to help in the creation of the script. This code will be referenced within the report https://docs.microsoft.com/en-us/dotnet/api/system.collections.generic.queue-1?view=net-6.0
    }
    ...
    public void flagPressed(string flag)
    {
        ...
        if (completedOrder()) // check if melody is complete
        {
            ...
            DoorLight.GetComponent<ToggleRoomCompleteLight>().GreenLightOn(); //gets the relevant game component and toggles the room complete light with GreenLightOn
