...
public class MelodyProgressTracker : MonoBehaviour
{
    ...
    void Start()
    {
        expectedMelody = new string[] {"C", "G", "F", "E", "D", "C2", "G"}; // The reference provided was used / modify to help in the creation of the script. This code will be referenced within the report https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/arrays/
        playedMelody = new Queue<string>(new string[] {"H", "H", "H", "H", "H", "H", "H"}); // The reference provided was used / modify to help in the creation of the script. This code will be referenced within the report https://docs.microsoft.com/en-us/dotnet/api/system.collections.generic.queue-1?view=net-6.0
    }
